...
class CPond_Form_Ride_Insert extends Zend_Dojo_Form {
    public function init() {
        $this->setMethod('post');
        $this->addElement('RadioButton', 'type', array(
                              'label' => 'Tipo di inserimento:',
                              'multiOptions' => array(
                                  'OFFER' => 'Offerta passaggio',
                                  'NEED' => 'Richiesta passaggio'
                              ),
                              'value' => 'NEED',
                              'onClick' => 'rideTypeChange(this);'
                          ));

        $this->addElement('RadioButton', 'repeatable', array(
                              'label' => 'Questo inserimento è valido:',
                              'multiOptions' => array(
                                  0 => 'Una volta soltanto',
                                  1 => 'Periodicamente'
                              ),
                              'value' => 0,
        ...
        $this->addElement('NumberSpinner', 'num_spots', array(
        ...
        $this->addElement('Textarea', 'purpose', array(
